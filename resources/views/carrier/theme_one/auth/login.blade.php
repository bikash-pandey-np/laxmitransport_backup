                    ...
                    <div class="col-lg-6">
                        <div class="info d-flex justify-content-center flex-column p-4 h-100">
                            <div class="py-5">
                                ...
                                <p class="fw-light mb-0">Carrier Login</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 bg-white">
                        <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                            <form class="login-form py-5 w-100" action="{{ route('carrier.login') }}" method="post">
                                @csrf
                                @if(session('error'))
                                ...
                                <br>
                                <a class="text-sm text-paleBlue" href="{{ route('carrier.forget_password_form') }}">Forgot Password?</a>
                                <br>
                                <small class="text-gray-500">Do not have an account? </small><a class="text-sm text-paleBlue" href="{{ route('carrier.register_form') }}">Signup</a>
                            </form>
                        </div>
                    </div>
                </div>
