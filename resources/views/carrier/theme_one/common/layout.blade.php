    ...
    <header class="header z-index-50">
        <nav class="navbar py-3 px-0 shadow-sm text-white position-relative">
            <div class="search-box shadow-sm">
                ...
                <form id="searchForm" action="{{ route('carrier.search.index') }}" role="search">
            ...
            <div class="container-fluid w-100">
                <div class="navbar-holder d-flex align-items-center justify-content-between w-100">
                    <div class="navbar-header">
                        <a class="navbar-brand d-none d-sm-inline-block" href="{{ route('carrier.index') }}">
...
{{--                        </div>--}}
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <li class="nav-item">
                            <form action="{{ route('carrier.logout') }}" method="post" id="logout_form">
    ...
    <div class="page-content d-flex align-items-stretch">
        <nav class="side-navbar z-index-40">
            <div class="sidebar-header d-flex align-items-center py-4 px-3">
                <a href="{{ route('carrier.profile.index') }}">
                    <img class="avatar shadow-0 img-fluid rounded-circle"
                         src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTugu0kegXOT1Gh1sgDVHvYjkGW29w19Hl9gQ&usqp=CAU" alt="...">
                </a>
                <div class="ms-3 title">
                    <h1 class="h4 mb-2">{{ $auth->full_name }}</h1>
                    <p class="text-sm text-gray-500 fw-light mb-0 lh-1">Carrier</p>
                </div>
            </div>
                    ...
                    @else
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-3">
                                <li class="breadcrumb-item"><a class="fw-light" href="{{ route('carrier.index') }}">Dashboard</a>
                                </li>
