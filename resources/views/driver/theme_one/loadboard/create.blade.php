            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('driver.loadboard.store',request('id')) }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-material-group mb-3">
                                            <input class="input-material" id="register-username" type="text" name="amount" value="{{ $row->amount ?? '' }}">
