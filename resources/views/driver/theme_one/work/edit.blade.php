                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="input-material-group mb-3">
                                                    ...
                                                    @else
                                                        <label class="label-material" id="date_time_text" for="date">Date</label>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="input-material-group mb-3">
                                                    <input class="input-material" id="time" type="text" required
                                                           name="time" value="{{ old('time') }}">
                                                    @if($errors->has('time'))
                                                        <div class="js-validate-error-label"
                                                             style="color: #B81111">{{ $errors->first('time') }}</div>
                                                    @else
                                                        <label class="label-material" id="time_text" for="time">Time</label>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
...
{{--                                    </div>--}}
                                ...
                                <div class="row" id="images" style="display: none;">
                                    ...
                                    <div class="col-sm-6" id="pod_signed_by">
                                        <div class="input-material-group mb-3">
...
@push('js')
    <script>
        $("#status").on("change",function(){
            ...
            $('#drop').hide();
            $('#images').hide();
            $('#date_time_text').text('Date');
            $('#time_text').text('Time');
            if($(this).val() == "Loaded At Shipper"){
                $('#pickup').show();
                $('#images').show();
                $('#date_time_text').text('Pickup Date');
                $('#time_text').text('Pickup Time');
                $('#pod_signed_by').hide();
            }
            if($(this).val() == "Unloaded"){
                $('#drop').show();
                $('#images').show();
                $('#date_time_text').text('Drop Date');
                $('#time_text').text('Drop Time');
                $('#pod_signed_by').show();
            }
        });
    </script>
