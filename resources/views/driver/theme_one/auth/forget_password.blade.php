                    ...
                    <div class="col-lg-6">
                        <div class="info d-flex justify-content-center flex-column p-4 h-100">
                            <div class="py-5">
                                ...
                                <p class="fw-light mb-0">Driver Forget Password</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 bg-white">
                        <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                            <form class="register-form py-5 w-100" action="{{ route('driver.forget_password') }}" method="post" novalidate="novalidate">
                                @csrf
                                ...
                                <button class="btn btn-primary mb-3" id="login" type="submit">Send Email</button><br><a class="text-sm text-paleBlue" href="{{ route('driver.login_form') }}">Login</a>
                            </form>
                        </div>
                    </div>
                </div>
