                    ...
                    <div class="col-lg-6">
                        <div class="info d-flex justify-content-center flex-column p-4 h-100">
                            <div class="py-5">
                                ...
                                <p class="fw-light mb-0">Admin Login</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 bg-white">
                        <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                            <form class="login-form py-5 w-100" action="{{ route('admin.login') }}" method="post">
				@csrf
@if(session('error'))
                                ...
                                <br>
                                <a class="text-sm text-paleBlue" href="{{ route('admin.forget_password_form') }}">Forgot Password?</a>
                            </form>
                        </div>
                    </div>
                </div>
