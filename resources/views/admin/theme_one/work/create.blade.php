...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 py-3">
            <li class="breadcrumb-item"><a class="fw-light" href="{{ route('admin.index') }}">Dashboard</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="h4 mb-0">{{ $title ?? 'Title' }} Create Form</h3>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route($base_route.'store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
