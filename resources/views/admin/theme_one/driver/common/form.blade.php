@foreach (config('form.driver') as $field => $type)
    @if ($field == 'address_one' || $field == 'address_two')
...
<div class="col-sm-12">
    ...
    @if (isset($row))
        <img src="{{ $row->image('300_300') }}" style="width: 100%">
    @endif
</div>
...
<div class="col-sm-6">
    ...
    @if (isset($row))
        <img src="{{ $row->frontCitizenship('300_300') }}" style="width: 100%">
    @endif
</div>
...
<div class="col-sm-6">
    ...
    @if (isset($row))
        <img src="{{ $row->frontLicense('300_300') }}" style="width: 100%">
    @endif
</div>
...
<div class="col-sm-6">
    ...
    @if (isset($row))
        <img src="{{ $row->backLicense('300_300') }}" style="width: 100%">
    @endif
</div>
...
<div class="col-sm-6">
    ...
    @if (isset($row))
        <img src="{{ $row->socialSecurityImage('300_300') }}" style="width: 100%">
    @endif
</div>
...
{{-- <div class="col-sm-4">
    ...
    @if (isset($row))
        <img src="{{ $row->backCitizenship('300_300') }}" style="width: 100%">
    @endif
</div> --}}
