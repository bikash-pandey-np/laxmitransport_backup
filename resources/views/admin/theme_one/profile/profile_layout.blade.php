                ...
                <div class="col-lg-3">
                    <div class="card mb-0">
                            ...
                            <div class="card-body text-center">
                                ...
                                <ul class="nav">
                                    <li class="nav-items nav-item"><a href="{{ route('admin.profile.edit') }}">Profile Update</a></li>
                                    <li class="nav-items nav-item"><a href="{{ route('admin.profile.picture.edit') }}">Change Profile Picture</a></li>
                                    <li class="nav-items nav-item"><a href="{{ route('admin.change.password') }}">Change Password</a></li>
                                </ul>
                            </div>
                    </div>
                </div>
