    ...
    <header class="header z-index-50">
        <nav class="navbar py-3 px-0 shadow-sm text-white position-relative">
            <div class="search-box shadow-sm">
                ...
                <form id="searchForm" action="{{ route('admin.search.index') }}" role="search">
            ...
            <div class="container-fluid w-100">
                <div class="navbar-holder d-flex align-items-center justify-content-between w-100">
                    <div class="navbar-header">
                        <a class="navbar-brand d-none d-sm-inline-block" href="{{ route('admin.index') }}">
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link text-white" id="messages" rel="nofollow"
                                                         href="{{ route('admin.chat.index') }}" aria-expanded="false">
                                <svg class="svg-icon svg-icon-xs svg-icon-heavy">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end mt-3 shadow-sm" aria-labelledby="messages">
                                <li><a class="dropdown-item d-flex py-3" href="{{ route('admin.chat.message',['role' => 'driver','id' => 1]) }}"> <img class="img-fluid rounded-circle"
                                ...
                                <li><a class="dropdown-item text-center" href="{{ route('admin.chat.index') }}"> <strong
