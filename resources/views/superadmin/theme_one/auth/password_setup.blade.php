                    ...
                    <div class="col-lg-6">
                        <div class="info d-flex justify-content-center flex-column p-4 h-100">
                            <div class="py-5">
                                ...
                                <p class="fw-light mb-0">Password Setup</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 bg-white">
                        <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                            <form class="login-form py-5 w-100" action="{{ route('super_admin.setup_password',request('token')) }}" method="post">
                                @csrf
                                ...
                                <div class="input-material-group mb-4">
                                    <input class="input-material" id="confirm_password" type="password" name="confirm_password" required data-validate-field="loginPassword">
