...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 py-3">
            ...
            @if(!(isset($hidemenu) && $hidemenu == true))
                <li class="breadcrumb-item"><a class="fw-light"
                                               href="{{ route($base_route.'index') }}">Fleets</a>
                </li>
            @endif
            @if(Request::is('super-admin/vehicle/available'))
                <li class="breadcrumb-item active fw-light" aria-current="page">Available</li>
            @elseif(Request::is('super-admin/vehicle/available'))
                <li class="breadcrumb-item active fw-light" aria-current="page">Not Available</li>
            @else
                <li class="breadcrumb-item active fw-light" aria-current="page">Vehicle</li>
            @endif
        </ol>
    </nav>
@endsection
