...
<div style="display:flex;">
    @if (auth('super_admin')->id() !== $row->id)
        <a href="{{ route('super_admin.chat.message', ['role' => 'admin', 'id' => $row->id]) }}">
        ...
        <a href="{{ route($base_route . '.show', $row) }}">
            <button title="Show {{ $title ?? '' }}" class="btn btn-xs btn-warning"><i class="fa fa-eye"></i></button>
        </a>
