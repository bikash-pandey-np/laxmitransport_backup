            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('super_admin.admin.store') }}" method="post">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-9 ms-auto">
                                        <button class="btn btn-secondary" type="submit" name="button" value="save">Save</button>
