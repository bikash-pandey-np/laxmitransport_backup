...
<div style="display:flex;">
    ...
    <a href="{{ route($base_route . '.show', $row) }}"><button title="View {{ $title ?? '' }}"
            class="btn btn-xs btn-success"><i class="fa fa-eye"></i></button></a>
    <a href="{{ route($base_route . '.edit', $row) }}"><button title="Edit {{ $title ?? '' }}"
