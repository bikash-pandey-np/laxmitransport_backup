...
use App\DataTables\Carrier\LoadBoardDataTable;
use App\DataTables\Carrier\MyLoadBoardDataTable;
...
class LoadBoardController extends CarrierBaseController
{
    ...
    public function create($id)
    {
        ...
        $row = LoadBoardUser::where('table_type', Carrier::class)->where('load_board_id',$id)->first();
    ...
    public function store(Request $request,$id)
    {
        ...
        if ($bidUser = LoadBoardUser::where([
            'load_board_id' => $id,
            'table_type' => Carrier::class,
            'table_id' => auth('carrier')->id(),
        ])->first()){
            $bidUser->update([
        ...
        return redirect()->route('carrier.loadboard.my')->with('success','Applied Successful');
    }
