...
class CarrierBaseController extends Controller
{
    public $theme_path = 'carrier.theme_one.';
    public $view_path = "";
    public $base_route = "";
    public $title = "";
    ...
    public function __loadView($view)
    {
        ...
        View::composer($view,function ($view){
            ...
            $view->with('base_route', 'carrier.'.$this->base_route.'.');
    ...
    {
        if ($request->save) {
            return redirect()->route('carrier.' . $this->base_route . '.index')->with('success', $this->title . ' Update Successful.');
        }
