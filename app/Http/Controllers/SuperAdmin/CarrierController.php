...
use App\DataTables\SuperAdmin\CarrierDataTable;
...
class CarrierController extends SuperAdminBaseController
{
    public $view_path = "carrier";
    public $base_route = "carrier";
    public $title = "Carrier";
