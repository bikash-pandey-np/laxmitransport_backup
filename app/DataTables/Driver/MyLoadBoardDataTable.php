...
class MyLoadBoardDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($query) {
                return view('driver.theme_one.loadboard.button.my_action', ['row' => $query, 'base_route' => 'driver.work']);
    ...
    {
        return $model->where('table_type', Driver::class)
            ->where('table_id', auth('driver')->id())->orderBy('created_at', 'desc')->newQuery();
    }
